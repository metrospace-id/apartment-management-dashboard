                ...
                <div className={`transition-all bg-white ${isProfileOpen ? 'mt-0' : 'mt-[-200%]'} dark:bg-slate-900`}>
                  ...
                  <div className="border-b border-slate-200 py-2">
                    <ul>
                      ...
                      <li className="py-2 px-4 cursor-pointer flex gap-1 items-center text-slate-600 hover:bg-slate-200 dark:hover:bg-slate-700 dark:text-white" onClick={() => navigation('/todo')} role="presentation">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
