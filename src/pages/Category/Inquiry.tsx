...
const PAGE_NAME = 'Kategori Inquiry'
...
const PageCategoryWork = () => {
  ...
  const apiSubmitCreate = () =>
    api({
      url: '/v1/inquiry-category/create',
      withAuth: true,
      method: 'POST',
      data: fields
    })
  ...
  const apiSubmitUpdate = () =>
    api({
      url: `/v1/inquiry-category/${fields.id}`,
      withAuth: true,
      method: 'PUT',
      data: fields
    })
  ...
  const handleGetInquiryCategories = () => {
  ...
  const tableDatas = data.data.map((column) => ({
    ...
    action: (
      <div className="flex items-center gap-1">
        ...
        {userPermissions.includes('category-inquiry-edit') && (
        ...
        {userPermissions.includes('category-inquiry-delete') && (
  ...
  return (
    <Layout>
      ...
      <Modal open={modalForm.open} title={modalForm.title}>
        ...
        >
          <Input
            placeholder="Nama Kategori Inquiry"
            label="Nama Kategori Inquiry"
            name="name"
            value={fields.name}
