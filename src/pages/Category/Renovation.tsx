...
const PAGE_NAME = 'Kategori Renovasi'
...
const PageCategoryWork = () => {
  ...
  const apiSubmitCreate = () =>
    api({
      url: '/v1/renovation-category/create',
      withAuth: true,
      method: 'POST',
      data: fields
    })
  ...
  const apiSubmitUpdate = () =>
    api({
      url: `/v1/renovation-category/${fields.id}`,
      withAuth: true,
      method: 'PUT',
      data: fields
    })
  ...
  const handleGetRenovationCategories = () => {
  ...
  const tableDatas = data.data.map((column) => ({
    ...
    action: (
      <div className="flex items-center gap-1">
        ...
        {userPermissions.includes('category-renovation-edit') && (
  ...
  return (
    <Layout>
      ...
      <Modal open={modalForm.open} title={modalForm.title}>
        ...
        >
          <Input
            placeholder="Nama Kategori Renovasi"
            label="Nama Kategori Renovasi"
            name="name"
            value={fields.name}
