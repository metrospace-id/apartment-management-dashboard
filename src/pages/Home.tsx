      ...
      <div className="p-4 dark:bg-slate-900 w-[100vw] sm:w-full flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="rounded-lg bg-white dark:bg-slate-950 p-4">
            <p className="text-sm sm:text-md text-slate-600 font-semibold dark:text-white">Jumlah Unit</p>
          ...
          <div className="rounded-lg bg-white dark:bg-slate-950 p-4">
            <p className="text-sm sm:text-md text-slate-600 font-semibold dark:text-white">Jumlah Pemilik</p>
            <div className="flex gap-2 items-center text-slate-500">
          ...
          <div className="rounded-lg bg-white dark:bg-slate-950 p-4">
            <p className="text-sm sm:text-md text-slate-600 font-semibold dark:text-white">Jumlah Penghuni</p>
            <div className="flex gap-2 items-center text-slate-500">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
          ...
          <div className="rounded-lg bg-white dark:bg-slate-950 p-4">
            <p className="text-sm sm:text-md text-slate-600 font-semibold dark:text-white">Jumlah Kendaraan</p>
            <div className="flex gap-2 items-center text-slate-500">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="p-4 flex flex-col gap-4 bg-white rounded-lg dark:bg-slate-950">
            <p className="text-sm sm:text-md text-slate-600 dark:text-white font-semibold">Chart Donat</p>
