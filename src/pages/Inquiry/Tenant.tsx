        ...
        <form autoComplete="off" className="flex gap-4 p-6">
          ...
          <div className="flex flex-col gap-4 flex-1">
            ...
            <Select
              ...
              value={fields.department_admin_id}
              onChange={(e) => handleChangeField(e.target.name, e.target.value)}
              readOnly={modalForm.readOnly}
              fullWidth
              options={[{
                label: 'Pilih Admin Department',
                value: '',
                disabled: true,
              },
              {
                label: 'Admin Department 1',
                value: 1,
              }]}
              disabled={!fields.department_id}
            />
            ...
            <Select
              ...
              fullWidth
              options={[{
                label: 'Pilih Karyawan Department',
                value: '',
                disabled: true,
              },
              {
                label: 'Karyawan Department 1',
                value: 1,
              }]}
              disabled={!fields.department_admin_id}
            />
